    ...
    class PlayingField
    {
        ...
        public void Initialize(ContentManager Content)
        {
          ...
          {  new Cell(Content, "22", 1, new Vector2(60, 360)) ,
           ...
           { new Cell(Content, "31", 0, new Vector2(0, 300)) ,
            new Cell(Content, "33", 0, new Vector2(120, 300)) ,
            new Cell(Content, "35", 0, new Vector2(240, 300)),
            new Cell(Content, "37", 0, new Vector2(360, 300)) },
           { new Cell(Content, "42", 2, new Vector2(60, 240)),
            new Cell(Content, "44", 2, new Vector2(180, 240)),
           ...
           { new Cell(Content, "51", 0, new Vector2(0, 180)),
            ...
            new Cell(Content, "57", 1, new Vector2(360, 180)) },
