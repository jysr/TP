    ...
    class MainMenu
    {
        ...
        public MainMenu()
        {
            ...
            {   //MainMenu
                (new List<GUIElement>
                {
                    new GUIElement("Graphics\\mainMenu"),
                    new GUIElement("Graphics\\mine"),
                    new GUIElement("Graphics\\player")
                }),
                //Enter name menu
                (new List<GUIElement>
                {
                    new GUIElement("Graphics\\laser"),
                    new GUIElement("Graphics\\explosion"),
                })
        ...
        {
            if (element == "Graphics\\player")//PlayButton
            {
                gameState = GameState.inGame;
            }
            if (element == "Graphics\\mine")//EnterName button
            {
                gameState = GameState.enterName;
            }
            if (element == "Graphics\\explosion")//Done button
            {
